...
AP_VideoTX::PowerLevel AP_VideoTX::_power_levels[VTX_MAX_POWER_LEVELS] = {
    ...
    { 0x14, 1500, 32, 0xFF }, // 1.5W for high power VTX (Tramp)
    { 0x15, 3000, 35, 0xFF }, // 3W for high power VTX (Tramp)
    { 0x16, 4000, 36, 0xFF }, // 4W for high power VTX (Tramp)
    { 0x17, 5000, 37, 0xFF }, // 5W for high power VTX (Tramp)
